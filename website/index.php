...
<body>
    ...
    <main class="main">
        ...
        <section class="service contents-bg" id="service">
            <div class="contents-title">
                <h1 class="head fade-in fade-in-up">SERVICE</h1>
                <div class="sub fade-in fade-in-up">サービス</div>
            </div>
            <ul class="contents-detail service-detail">
                <li class="service-item">
                    <img class="fade-in fade-in-up" src="<?php echo get_template_directory_uri(); ?>/src/images/service/service01.jpg" alt="">
                    <div class="text">
                ...
                <li class="service-item">
                    <img class="fade-in fade-in-up" src="<?php echo get_template_directory_uri(); ?>/src/images/service/service02.jpg" alt="">
                    <div class="text">
        ...
        <div class="floor-img">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/floor/floor-top.png" alt="">
        </div>
        <section class="floor contents-width" id="floor">
            <div class="contents-title">
                <h1 class="head fade-in fade-in-up">FLOOR</h1>
                <div class="sub fade-in fade-in-up">施設紹介</div>
            </div>
            <ul class="contents-detail">
                <li class="floor-item">
                    <img class="fade-in fade-in-up" src="<?php echo get_template_directory_uri(); ?>/src/images/floor/floor01.png" alt="">
                    <div class="text">
        ...
        <section class="news contents-bg" id="news">
            <div class="contents-title">
                <h1 class="head fade-in fade-in-up">NEWS</h1>
        ...
        <section class="access contents-width" id="access">
            <div class="contents-title">
                <h1 class="head fade-in fade-in-up">ACCESS</h1>
                <div class="sub fade-in fade-in-up">アクセス</div>
            </div>
            <div class="contents-detail">
                <table class="access-table">
                    <tr class="table-item">
                        <td>address</td>
                        <td>埼玉県所沢市緑町4−5−16マルク新所沢201</td>
                    </tr>
                    <tr class="table-item">
                        <td>e-mail</td>
                    ...
                    <tr class="table-item">
                        <td>open</td>
                        <td>09:00～21:00 / 最終受付18:00</td>
                    </tr>
                </table>
                <div class="access-iframe">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6471.533925080133!2d139.44725772611295!3d35.80565392066183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6018dd1aa63771a7%3A0x237bd6fd27d1138a!2sPERSONAL%20BODYMAKE%20SALON%20%E3%80%8ECOLLECT%E3%80%8F!5e0!3m2!1sja!2sjp!4v1640354762069!5m2!1sja!2sjp" max-width="600" width="80%" max-height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
        </section>
        <section class="contact contents-bg" id="contact">
            <div class="contents-title">
        ...
        <aside class="counselor-icon">
            <div class="main-title">
                <a href="https://www.google.com/maps/reserve/v/default?m=E3g0BVzyI4k&source=pa&gei=hdBwYoPmOc3AhwOw5JjIDw&sourceurl=https://www.google.co.jp/search?q%3DPERSONAL%2BBODYMAKE%2BSALON%2BCOLLECT%26ie%3DUTF-8%26oe%3DUTF-8%26hl%3Dja-jp%26client%3Dsafari&hl=ja-JP">
                    1周年記念！<br class="sp-only">体験2980円！
                </a>
            </div>
        </aside>
    </main>
